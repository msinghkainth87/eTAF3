...
import static seleniumutils.methods.GlobalProperties.DEFAULT_WAIT;
...
public class AXE {
	 ...
	 */
	public static synchronized void writeResults(final String name, final Object output) {
		Writer writer = null;
	...
	public static class Builder {
		...
		private JSONObject execute(final String command, final Object... args) {
			...
			this.driver.manage().timeouts().setScriptTimeout(DEFAULT_WAIT, TimeUnit.SECONDS);
